...
import './product.css'
import productimg from '../../../../../Resources/1.jpeg'

const Product = () => {
    return (
        <div class="container1 shadow-2xl">
            <section class="text-gray-600 body-font overflow-hidden">
                <div class="container px-5 py-24 mx-auto">
                    <div class="lg:w-7/8 mx-auto flex flex-wrap">
                        <img alt="ecommerce" class="lg:w-1/2 w-full lg:h-auto h-64 object-cover object-center rounded mar" src={productimg} />
                        <div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                            ...
                            <div class='f1'>
                                <h1 class="text-gray-900 text-3xl title-font font-medium mb-1">Coconut oil</h1>
                            ...
                            <div class="f2 flex-col">
                                <button class="flex ml-0 text-white bg-green-500 border-0 py-2 px-6 focus:outline-none hover:bg-green-600 rounded justify-center">Add to cart</button>
                                <br />
                                <button class="flex ml-0 text-white bg-green-500 border-0 py-2 px-6 focus:outline-none hover:bg-green-600 rounded justify-center">Buy now</button>
                            </div>
                        </div>
                    </div>
                </div>
